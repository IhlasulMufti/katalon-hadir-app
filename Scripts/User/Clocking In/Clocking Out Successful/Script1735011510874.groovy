...
WebUI.scrollToElement(findTestObject('User/Absent/button_Keluar'), 5)

WebUI.click(findTestObject('User/Absent/button_Keluar'))
...
WebUI.setText(findTestObject('User/Absent/input_Clocking_Out_Notes'), note)

WebUI.click(findTestObject('User/Absent/button_Submit_Clocking_Out'))
